...
export default function TablePreView() {
  ...
  /*
    {
    document.getElementById("tippy-pop").innerHTML=
       ' <div class="dropdown-content-dot-pop" id="drop-pop">'+
       ' <a class="cell-pop" onClick=handleClickOpen(params)><i class="fa fa-edit act-icon"></i> Edit</a>'+
   '  <a class="cell-pop" onClick= onDelete(params)><i class="fa fa-trash act-icon"></i> Delete</a>'+
    ' <a class="cell-pop" onClick= handlepopopen(params)><i class="fa fa-clone act-icon"></i> Clone</a>'+
       '  </div>'
    ...
    <div className="over-pop">
            <div class="dropdown-dot-pop">
              <i class="fa fa-2x fa-ellipsis-v dropbtn-dot-pop dot-pops" ></i>
              <div class="dropdown-content-dot-pop" id="drop-pop">
             <a class="cell-pop" onClick={() => handleClickOpen(params)}><i class="fa fa-edit act-icon"></i> Edit</a>
          <a class="cell-pop" onClick={() => onDelete(params)}><i class="fa fa-trash act-icon"></i> Delete</a>
          <a class="cell-pop" onClick={() => handlepopopen(params)}><i class="fa fa-clone act-icon"></i> Clone</a>
    ...
    <div className="pdf">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content">
          <a onClick={() => onExportClick()} >As Excel</a>
